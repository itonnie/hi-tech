...
var AppdataService = (function () {
    ...
    AppdataService.prototype.makeAppointment = function (from, to, county, fullname, town, street, phone, category, sub, subsub, desc, email, warranty) {
    ...
    function OrderComponent(rActivated, appdata, router, fb, snack) {
        ...
        this.appdata.currentId.subscribe(function (data) {
            ...
            _this.appdata.viewOrder(data).subscribe(function (response) {
                ...
                _this.to = new Date(response.data.to);
                _this.from = new Date(response.data.from);
...
var ScheduleComponent = (function () {
    function ScheduleComponent(ar, snackbar, router, appdata, fb) {
        ...
        this.rForm = fb.group({
            ...
            'from': [null, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["i" /* Validators */].required],
            'to': [null, __WEBPACK_IMPORTED_MODULE_2__angular_forms__["i" /* Validators */].required],
    ...
    ScheduleComponent.prototype.scheduleAppointment = function (form) {
        var _this = this;
        this.appdata.makeAppointment(form.from, form.to, form.select, form.fullname, form.town, form.street, form.phone, this.category, this.sub, this.subsub, form.description, form.email, form.warranty).subscribe(function (data) {
            if (data.ok == true) {
