...
module.exports = "<div class=\"jumbotron\">\n  <div class=\"flexbox\">\n    <div class=\"leftPanel\">\n      <h1 style=\"font-family: 'Segoe UI Light';\">{{category}}</h1>\n      <h3 style=\"font-family: 'Segoe UI Light';\"><strong>{{sub}}</strong></h3>\n\n      <p class=\"lead\"> Thank you for choosing us to do your <strong>{{name}}</strong> for you.</p>\n      <p class=\"lead\"> Please book an appointment for out experts to come to you at your own convinient time to make you a quotation and view the job.</p>\n    </div>\n\n    <div class=\"rightPanel\">\n      <div class=\"card\">\n        <div class=\"card-body\">\n\n          Schedule a time that is convinient for you\n\n          <br>\n\n          <div class=\"input-group\">\n            <span class=\"input-group-addon\" id=\"from\">From:</span>\n            <input type=\"datetime-local\" name=\"from\" id=\"from\" class=\"form-control\" [(ngModel)]=\"from\" required>\n          </div>\n          <p class=\"text-danger\">{{fromerr}}</p>\n\n          <br>\n\n          <div class=\"input-group\">\n            <span class=\"input-group-addon\" id=\"to\">To:</span>\n            <input type=\"datetime-local\" class=\"form-control\" name=\"to\" id=\"to\" [(ngModel)]=\"to\" required>\n          </div>\n          <span class=\"text-danger\">{{toerr}}</span>\n\n          <br>\n          <span class=\"label label-default\">County</span>\n          <mat-select [placeholder]=\"County\" [(ngModel)]=\"select\">\n            <mat-option *ngFor=\"let county of counties\" [value]=\"county\">\n              {{county}}\n            </mat-option>\n          </mat-select>\n          <span class=\"text-danger\">{{selerr}}</span>\n\n          <br>\n          <br>\n\n          <input type=\"text\" name=\"fullname\" id=\"fullname\" class=\"form-control\" placeholder=\"Full Names\" [(ngModel)]=\"fullname\" required>\n          <span class=\"text-danger\">{{fullerr}}</span>\n          <br>\n\n          <input type=\"text\" name=\"town\" id=\"town\" class=\"form-control\" placeholder=\"Town\" [(ngModel)]=\"town\" required>\n          <span class=\"text-danger\">{{twnerr}}</span>\n          <br>\n\n          <input type=\"text\" name=\"street\" id=\"street\" class=\"form-control\" [(ngModel)]=\"street\" placeholder=\"Street Address\" required>\n          <span class=\"text-danger\">{{sterr}}</span>\n          <br>\n\n          <input type=\"number\" name=\"phone\" id=\"phone\" class=\"form-control\" [(ngModel)]=\"phone\" placeholder=\"Phone\" required>\n          <span class=\"text-danger\">{{pherr}}</span>\n          <br>\n\n          <div class=\"text-center\">\n            <button mat-button full color=\"primary\" (click)=\"scheduleAppointment()\"> Schedule Appointment</button>\n          </div>\n\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
var ScheduleComponent = (function () {
    ...
    ScheduleComponent.prototype.scheduleAppointment = function () {
        if (this.from == undefined) {
            ...
            //send data
            this.appdata.makeAppointment(this.from, this.to, this.select, this.fullname, this.town, this.street, this.phone, this.category, this.sub, this.name).subscribe(function (data) {
                if (data.ok == true) {
